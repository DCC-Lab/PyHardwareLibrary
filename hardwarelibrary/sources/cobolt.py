...
class CoboltDevice(LaserSourceDevice, OnOffCapability, PowerCapability,
    ...
    commands = {
        "GET_POWER": TextCommand(name="GET_POWER",
            requestEncoder="pa?\r",
            requestDecoder=r"pa\?\r",
            replyDecoder=r"(\d+\.\d+)",
            replyEncoder="{power:0.4f}\r\n"),
        "GET_REQUESTED_POWER": TextCommand(name="GET_REQUESTED_POWER",
            requestEncoder="p?\r",
            requestDecoder=r"p\?\r",
            replyDecoder=r"(\d+\.\d+)",
            replyEncoder="{requestedPower:0.4f}\r\n"),
        "SET_POWER": TextCommand(name="SET_POWER",
            requestEncoder="p {0:0.3f}\r",
            requestDecoder=r"p (?P<value>\d+\.?\d+)\r",
            replyDecoder=r"OK"),
        "GET_ON_OFF": TextCommand(name="GET_ON_OFF",
            requestEncoder="l?\r",
            requestDecoder=r"l\?\r",
            replyDecoder=r"(0|1)",
            replyEncoder="{isOn}\r\n"),
        "TURN_ON": TextCommand(name="TURN_ON",
            requestEncoder="l1\r",
            requestDecoder=r"l1\r",
            replyDecoder=r"OK"),
        "TURN_OFF": TextCommand(name="TURN_OFF",
            requestEncoder="l0\r",
            requestDecoder=r"l0\r",
            replyDecoder=r"OK"),
        "GET_SERIAL_NUMBER": TextCommand(name="GET_SERIAL_NUMBER",
            requestEncoder="sn?\r",
            requestDecoder=r"sn\?\r",
            replyDecoder=r"(\d+)",
            replyEncoder="{serialNumber}\r\n"),
        "TURN_AUTOSTART_ON": TextCommand(name="TURN_AUTOSTART_ON",
            requestEncoder="@cobas 1\r",
            requestDecoder=r"@cobas 1\r",
            replyDecoder=r"OK"),
        "TURN_AUTOSTART_OFF": TextCommand(name="TURN_AUTOSTART_OFF",
            requestEncoder="@cobas 0\r",
            requestDecoder=r"@cobas 0\r",
            replyDecoder=r"OK"),
        "GET_AUTOSTART": TextCommand(name="GET_AUTOSTART",
            requestEncoder="@cobas?\r",
            requestDecoder=r"@cobas\?\r",
            replyDecoder=r"(0|1)",
            replyEncoder="{autostart}\r\n"),
        "GET_INTERLOCK": TextCommand(name="GET_INTERLOCK",
            requestEncoder="ilk?\r",
            requestDecoder=r"ilk\?\r",
            replyDecoder=r"(0|1)",
            replyEncoder="{interlock}\r\n"),
    }
