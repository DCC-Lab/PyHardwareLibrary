...
#     # # read 64 bytes.
#     # #     port = USBPort(idVendor=0x0661, idProduct = 0x3705)
#     # #     # port.terminator = b'\r'
#     # #     self.assertIsNotNone(port)
#     # #     port.open()
#     # #     self.assertTrue(port.isOpen)
#     # #     port.writeString(string="DV")
#     # #     count = 64
#     # #     while count > 0:
#     # #         try:
#     # #             print(count, port.readData(1))
...
class PhotonCounter(PhysicalDevice):
