...
So we can create a subclass of `CommunicationPort` that has the *specific details* of a USB port in these primitive functions, while making use of the general functions.  
